...
import { markers, mapDarkStyle, mapStandardStyle } from '../Map/model/mapArray';
...
function SearchCars({navigation}){
    ...
    return(
      ...
      >
        <Text style={{color:'red'}}>Search Cars</Text>
      </Pressable> */}
      <TouchableOpacity 
           onPress={() => setModalVisible(true)}
            style={[SearchCarStyle.signIn,{
                borderColor:"#8FC54B",
                borderWidth:1,
                marginTop:-5
            }]}
        >
            <Text style={[SearchCarStyle.textSign,{color:"white"
        }]}>
        Search Car
      </Text>
        </TouchableOpacity>
